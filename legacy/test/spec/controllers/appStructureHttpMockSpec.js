...
describe('Controller: appStructureController (HTTP Mocking)', function () {
    ...
    var appStructureController, scope, injector, location, flush, controller, httpBackend, templates;
    beforeEach(inject(function ($httpBackend) {
        ...
        httpBackend.when('GET', 'https://localhost/kirk/wizard/main?command=GetAppStructure&kreds=fakeCredentials&templateName=accountDev&isPlatform=false').respond(appStructure);
        var potentialTables = {
            "commands": [{
                    "name": "Data",
                    "paramCount": "2",
        ...
        httpBackend.when('GET', 'https://localhost/kirk/wizard/main?command=GetPotentialTables&kreds=fakeCredentials&templateName=accountDev').respond(potentialTables);
        var potentialCharts = {
            "commands": [{
                    "name": "Data",
                    "paramCount": "2",
        ...
        httpBackend.when('GET', 'https://localhost/kirk/wizard/main?command=GetCharts&kreds=fakeCredentials&templateName=accountDev').respond(potentialCharts);
        var dataStructure = {
            "commands": [{
                    "name": "Data",
                    "paramCount": "2",
        ...
        httpBackend.when('GET', 'https://localhost/kirk/wizard/main?command=GetDataStructure&kreds=fakeCredentials&templateName=accountDev&isPlatform=false').respond(dataStructure);
...
//# sourceMappingURL=appStructureHttpMockSpec.js.map