...
(function (wizard) {
    var mocks;
    (function (mocks) {
        var EncodedTemplatePiece = /** @class */ (function () {
            function EncodedTemplatePiece(template) {
                this.template = template;
            }
            EncodedTemplatePiece.prototype.encodedDataStructure = function () {
                return this.encode(this.template.dataStructure());
            };
            EncodedTemplatePiece.prototype.encodedAppStructure = function () {
                return this.encode(this.template.appStructure());
            };
            EncodedTemplatePiece.prototype.encodedPotentialTables = function () {
                return this.encode(this.template.potentialTables());
            };
            EncodedTemplatePiece.prototype.encodedPotentialCharts = function () {
                return this.encode(this.template.potentialCharts());
            };
            EncodedTemplatePiece.prototype.encode = function (structure) {
                return encodeURIComponent(btoa(JSON.stringify(structure)));
            };
            return EncodedTemplatePiece;
        }());
        mocks.EncodedTemplatePiece = EncodedTemplatePiece;
        var MockTemplate = /** @class */ (function () {
            function MockTemplate() {
            }
            return MockTemplate;
        }());
        mocks.MockTemplate = MockTemplate;
        var AccountDevTemplate = /** @class */ (function (_super) {
            __extends(AccountDevTemplate, _super);
            function AccountDevTemplate() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            AccountDevTemplate.prototype.appStructure = function () {
                return {
            ...
            AccountDevTemplate.prototype.dataStructure = function () {
                return {
                    "Outputs": [{
                            "UsePostProcessingOutputs": false,
            ...
            AccountDevTemplate.prototype.potentialTables = function () {
                return {
            ...
            AccountDevTemplate.prototype.potentialCharts = function () {
                return {
                    "Charts": [{
            ...
            return AccountDevTemplate;
        }(MockTemplate));
        mocks.AccountDevTemplate = AccountDevTemplate;
        var AccountDevTemplateWithNoMenu = /** @class */ (function (_super) {
            __extends(AccountDevTemplateWithNoMenu, _super);
            function AccountDevTemplateWithNoMenu() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            AccountDevTemplateWithNoMenu.prototype.appStructure = function () {
                return {
                    "PostProcessingOutputsForPortfolio": [{
                            "SendBack": "Tree!F11",
                            "Key": "value_given_success",
            ...
            return AccountDevTemplateWithNoMenu;
        }(AccountDevTemplate));
        mocks.AccountDevTemplateWithNoMenu = AccountDevTemplateWithNoMenu;
    })(mocks = wizard.mocks || (wizard.mocks = {}));
})(wizard || (wizard = {}));
//# sourceMappingURL=mockDataPool.js.map