/* Ported unchanged from huashan.version.ts */
export function getVersions() {
  return [
    { versionNo: '0.9.1', ChangeLog: ['Fix log in timeout', 'Add Synctemplate'] },
    { versionNo: '0.9.0', ChangeLog: ['Switch to Python 3.7', 'Fix SmartOrgrify'] },
    {
      versionNo: '0.8.2',
      ChangeLog: [
    ...
    {
      versionNo: '0.8.1',
      ChangeLog: ['Template version: View revision details and switch revision and download excel model'],
    },
    { versionNo: '0.8.0', ChangeLog: ['Template version: save and show revision list'] },
    { versionNo: '0.7.9', ChangeLog: ['Impletemented Pnl in Table command', 'Impletemented Pnl in Add_Tables'] },
    {
      versionNo: '0.7.8',
      ChangeLog: [
    ...
    },
    {
      versionNo: '0.7.6',
      ChangeLog: [
        'Portfolio commands should not show up in Appstructure fixed',
    ...
    { versionNo: '0.7.5', ChangeLog: ['Wizard will show loading spinner in datastructure'] },
    {
      versionNo: '0.7.4',
      ChangeLog: [
    ...
    { versionNo: '0.7.1', ChangeLog: ['XLSX and XLSM files can now be uploaded and downloaded'] },
    { versionNo: '0.7.0', ChangeLog: ['Input Screen bug for first time templates fixed'] },
    {
      versionNo: '0.6.9',
      ChangeLog: [
    ...
    { versionNo: '0.6.8', ChangeLog: ['Tornado weights bug fixed, now weights are correctly added'] },
    { versionNo: '0.6.7', ChangeLog: ['Check for Med probability being lower than High or Low probability added'] },
    { versionNo: '0.6.6', ChangeLog: ['Update Data Structure functionality added'] },
    {
      versionNo: '0.6.5',
      ChangeLog: ['Image menu id bug for quoted sheet names fixed', 'Files with underscores can no longer be updated'],
    },
    { versionNo: '0.6.4', ChangeLog: ['Downloading of Excel model now supported'] },
    { versionNo: '0.6.3', ChangeLog: ['Corrected Upload tooltip'] },
    { versionNo: '0.6.2', ChangeLog: ['Tornado depth bug fixed'] },
    { versionNo: '0.6.1', ChangeLog: ['All tests now pass'] },
    {
      versionNo: '0.6.0',
      ChangeLog: ['SmartOgrifier added for easier dataStructure entry', 'SmartOgrifier also does basic appStructure'],
    },
    {
      versionNo: '0.5.0',
      ChangeLog: [
